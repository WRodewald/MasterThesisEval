...
nls['en']['playButtonA'] = "Play A";
nls['en']['playButtonB'] = "Play B";
nls['en']['stopButton'] = "Stop"; 
nls['en']['pauseButton'] = "Pause";
nls['en']['pauseButtonA'] = "Pause A";
nls['en']['pauseButtonB'] = "Pause B";
...
nls['de']['playButtonA'] = "Start A";
nls['de']['playButtonB'] = "Start B";
nls['de']['stopButton'] = "Stopp"; 
nls['de']['pauseButton'] = "Pause";
nls['de']['pauseButton'] = "Pause A";
nls['de']['pauseButton'] = "Pause B";
nls['de']['sendButton'] = "Ergebnisse senden";

nls['fr']['nextButton'] = "Suivant";
nls['fr']['previousButton'] = "Précédent";
nls['fr']['playButton'] = "Play";
nls['fr']['playButtonA'] = "Play A";
nls['fr']['playButtonB'] = "Play B";
nls['fr']['stopButton'] = "Stop";
nls['fr']['pauseButton'] = "Pause";
nls['fr']['pauseButtonA'] = "Pause A";
nls['fr']['pauseButtonB'] = "Pause B";
