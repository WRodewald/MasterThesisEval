...
WaveformVisualizer.prototype.create = function(){
  ...
  this.canvas.addEventListener('click', (function(event){
    ...
    if(this.leftRegionPosition != newRegion.left){
      this.mushraAudioControl.setPositionFading(parseInt(newRegion.left/this.scale))
    }else if(this.rightRegionPosition != newRegion.right){
      this.mushraAudioControl.setPositionFading(parseInt(newRegion.right/this.scale + newRegion.left / this.scale))
    }
